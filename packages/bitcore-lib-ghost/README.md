...
**A pure and powerful JavaScript Ghost library.**
...
```sh
npm install bitcore-lib-ghost
```

```sh
bower install bitcore-lib-ghost
```
...
This will generate files named `bitcore-lib-ghost.js` and `bitcore-lib.min.js`.
